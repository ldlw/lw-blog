...
names.append("Jack");
names.append("Henry");
console.log(names.getElement()); // LiuWei
names.next();
...
```ts
{
	...
	doubleLink.insert('LiuWei', 'head')
	doubleLink.insert('xuexue', 'LiuWei')
...
```ts
{
	...
	list.insert('LiuWei', 'head')
	list.insert('xuexue', 'LiuWei')
	console.log('---------')
	list.display()
}
```
